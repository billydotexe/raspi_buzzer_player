...
melody = [
  notes['E4'], notes['A4'], notes['B4'], notes['C5'], notes['A4'], notes['E4'], notes['A4'], notes['B4'], notes['C5'], notes['A4'], notes['E4'], notes['A4'], notes['B4'], notes['C5'], notes['B4'], notes['A4'], notes['C5'], notes['B4'], notes['A4'], notes['E5'], notes['E5'], notes['E5'], notes['E5'], notes['D5'], notes['E5'], notes['F5'], notes['F5'], notes['F5'], notes['E5'], notes['D5'], notes['E5'], notes['C5'], notes['C5'], notes['C5'], notes['C5'], notes['B4'], notes['E5'], notes['C5'], notes['B4'], notes['A4']
]
tempo = [
  4, 4, 4, 4, 2, 4, 4, 4, 4, 2, 4, 4, 4, 2, 4, 4, 2, 4, 4, 2, 2, 4, 4, 4, 4, 4, 2, 4, 4, 4, 4, 2, 4, 4, 4, 2, 2, 2, 2, 2
]
